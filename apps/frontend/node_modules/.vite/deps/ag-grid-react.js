...
} from "./chunk-YTBNX4YF.js";
import {
  require_react
} from "./chunk-LZVOD3PK.js";
import {
  __commonJS,
  __toESM
...
var CustomWrapperComp = (params) => {
  ...
  return import_react3.default.createElement(CustomContext.Provider, { value: { setMethods } }, import_react3.default.createElement(CustomComponentClass, __spreadValues({}, props)));
};
...
var GroupCellRenderer = (0, import_react7.forwardRef)((props, ref) => {
  ...
  return import_react7.default.createElement("span", __spreadValues({ className, ref: setRef2 }, !props.colDef ? { role: (_a = ctrlRef.current) == null ? void 0 : _a.getCellAriaRole() } : {}), import_react7.default.createElement("span", { className: expandedClassName, ref: eExpandedRef }), import_react7.default.createElement("span", { className: contractedClassName, ref: eContractedRef }), import_react7.default.createElement("span", { className: checkboxClassName, ref: eCheckboxRef }), import_react7.default.createElement("span", { className: "ag-group-value", ref: eValueRef }, useValue && import_react7.default.createElement(import_react7.default.Fragment, null, escapedValue), useFwRenderer && import_react7.default.createElement(FwRenderer, __spreadValues({}, innerCompDetails.params))), import_react7.default.createElement("span", { className: "ag-group-child-count" }, childCount));
});
...
var HeaderCellComp = (props) => {
  ...
  return import_react13.default.createElement(
    ...
    import_react13.default.createElement("div", { ref: eResize, className: "ag-header-cell-resize", role: "presentation" }),
    import_react13.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp && userCompStateless && import_react13.default.createElement(UserCompClass, __spreadValues({}, userCompDetails.params)), reactUserComp && !userCompStateless && import_react13.default.createElement(UserCompClass, __spreadProps(__spreadValues({}, userCompDetails.params), { ref: userCompRef })))
  );
};
...
var HeaderGroupCellComp = (props) => {
  ...
  return import_react14.default.createElement(
    ...
    reactUserComp && userCompStateless && import_react14.default.createElement(UserCompClass, __spreadValues({}, userCompDetails.params)),
    reactUserComp && !userCompStateless && import_react14.default.createElement(UserCompClass, __spreadProps(__spreadValues({}, userCompDetails.params), { ref: userCompRef })),
    import_react14.default.createElement("div", { ref: eResize, "aria-hidden": resizableAriaHidden, className: resizableClassName })
  );
};
var headerGroupCellComp_default = (0, import_react14.memo)(HeaderGroupCellComp);
function getInstance(wrapperComponent, callback) {
  var _a, _b;
  const promise = (_b = (_a = wrapperComponent == null ? void 0 : wrapperComponent.getInstance) == null ? void 0 : _a.call(wrapperComponent)) != null ? _b : AgPromise.resolve(void 0);
...
var HeaderFilterCellComp = (props) => {
  ...
  const reactUserComp = userCompDetails && userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails && userCompDetails.componentClass;
  return import_react15.default.createElement("div", { ref: setRef2, className, role: "gridcell" }, import_react15.default.createElement("div", { ref: eFloatingFilterBody, className: bodyClassName, role: "presentation" }, reactUserComp && !reactiveCustomComponents && import_react15.default.createElement(UserCompClass, __spreadProps(__spreadValues({}, userCompDetails.params), { ref: userCompStateless ? () => {
  } : userCompRef })), reactUserComp && reactiveCustomComponents && import_react15.default.createElement(CustomContext.Provider, { value: {
    setMethods: (methods) => floatingFilterCompProxy.setMethods(methods)
  } }, import_react15.default.createElement(UserCompClass, __spreadValues({}, floatingFilterProps)))), import_react15.default.createElement("div", { ref: eButtonWrapper, "aria-hidden": buttonWrapperAriaHidden, className: buttonWrapperClassName, role: "presentation" }, import_react15.default.createElement("button", { ref: eButtonShowMainFilter, type: "button", className: "ag-button ag-floating-filter-button-button", tabIndex: -1 })));
};
...
var HeaderRowContainerComp = (props) => {
  ...
  return import_react11.default.createElement(import_react11.default.Fragment, null, pinnedLeft && import_react11.default.createElement("div", { ref: setRef2, className: "ag-pinned-left-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()), pinnedRight && import_react11.default.createElement("div", { ref: setRef2, className: "ag-pinned-right-header " + className, "aria-hidden": !displayed, role: "rowgroup" }, insertRowsJsx()), centre && import_react11.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "presentation" }, import_react11.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "rowgroup" }, insertRowsJsx())));
};
...
var jsxEditorProxy = (editDetails, CellEditorClass, setRef2) => {
  ...
  return import_react19.default.createElement(CustomContext.Provider, { value: {
    setMethods: (methods) => compProxy.setMethods(methods)
  } }, isStateless && import_react19.default.createElement(CellEditorClass, __spreadValues({}, props)), !isStateless && import_react19.default.createElement(CellEditorClass, __spreadProps(__spreadValues({}, props), { ref: (ref) => compProxy.setRef(ref) })));
};
var jsxEditor = (editDetails, CellEditorClass, setRef2) => {
  const newFormat = editDetails.compProxy;
  return import_react19.default.createElement(import_react19.default.Fragment, null, !newFormat && import_react19.default.createElement(CellEditorClass, __spreadProps(__spreadValues({}, editDetails.compDetails.params), { ref: setRef2 })), newFormat && jsxEditorProxy(editDetails, CellEditorClass, setRef2));
};
...
var jsxShowValue = (showDetails, key, parentId, cellRendererRef, showCellWrapper, reactCellRendererStateless, setECellValue) => {
  ...
  const bodyJsxFunc = () => import_react19.default.createElement(import_react19.default.Fragment, null, noCellRenderer && import_react19.default.createElement(import_react19.default.Fragment, null, valueForNoCellRenderer), reactCellRenderer && !reactCellRendererStateless && import_react19.default.createElement(CellRendererClass, __spreadProps(__spreadValues({}, compDetails.params), { key, ref: cellRendererRef })), reactCellRenderer && reactCellRendererStateless && import_react19.default.createElement(CellRendererClass, __spreadProps(__spreadValues({}, compDetails.params), { key })));
...
var CellComp = (props) => {
  ...
  return import_react19.default.createElement(
    ...
    showCellWrapper ? import_react19.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents()
  );
};
...
var RowComp = (params) => {
  ...
  const showFullWidthFrameworkJsx = () => {
    ...
    return import_react18.default.createElement(import_react18.default.Fragment, null, reactFullWidthCellRendererStateless && import_react18.default.createElement(FullWidthComp, __spreadValues({}, fullWidthCompDetails.params)), !reactFullWidthCellRendererStateless && import_react18.default.createElement(FullWidthComp, __spreadProps(__spreadValues({}, fullWidthCompDetails.params), { ref: fullWidthCompRef })));
  };
...
var RowContainerComp = (params) => {
  ...
  const { name } = params;
  const containerType = (0, import_react17.useMemo)(() => getRowContainerTypeForName(name), [name]);
  ...
  const cssClasses = (0, import_react17.useMemo)(() => RowContainerCtrl.getRowContainerCssClasses(name), [name]);
  ...
  const buildContainer = () => import_react17.default.createElement(
    "div",
    {
    ...
    rowCtrlsOrdered.map(
      (rowCtrl) => import_react17.default.createElement(rowComp_default, { rowCtrl, containerType, key: rowCtrl.getInstanceId() })
    )
  );
  return import_react17.default.createElement(import_react17.default.Fragment, null, centerTemplate ? import_react17.default.createElement("div", { className: viewportClasses, ref: setViewportRef, role: "presentation" }, buildContainer()) : buildContainer());
};
...
var GridBodyComp = () => {
  ...
  return import_react9.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, import_react9.default.createElement(gridHeaderComp_default, null), createSection({ section: eTop, className: topClasses, style: topStyle, children: [
...
var AgGridReactUi = (props) => {
  ...
  return import_react2.default.createElement("div", { style, className: props.className, ref: setRef2 }, context && !context.isDestroyed() ? import_react2.default.createElement(gridComp_default, { context }) : null, (_b = (_a = portalManager.current) == null ? void 0 : _a.getPortals()) != null ? _b : null);
};
...
var DetailCellRenderer = (0, import_react2.forwardRef)((props, ref) => {
  ...
  return import_react2.default.createElement("div", { className: topClassName, ref: setRef2 }, detailGridOptions && import_react2.default.createElement(AgGridReactUi, __spreadProps(__spreadValues({ className: gridClassName }, detailGridOptions), { modules: parentModules, rowData: detailRowData, setGridApi })));
});
...
var AgGridReact = class extends import_react.Component {
  ...
  render() {
    return import_react.default.createElement(AgGridReactUi, __spreadProps(__spreadValues({}, this.props), { setGridApi: this.setGridApi }));
  }
};
var ChangeDetectionStrategyType = ((ChangeDetectionStrategyType2) => {
